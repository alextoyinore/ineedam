                    ...
                    <form onSubmit={handleSubmit} style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{ position: 'relative', marginBottom: '2.5rem' }}>
                            ...
                            <div style={{
                                ...
                                <label style={{ position: 'absolute', bottom: '0.5rem', right: '0.5rem', background: 'rgba(0,0,0,0.5)', padding: '0.4rem', borderRadius: '50%', color: 'white', cursor: 'pointer', transition: 'background 0.2s' }} className="glass-panel-hover">
                                    <Camera size={16} />
                        ...
                        {/* Footer */}
                        <div style={{ display: 'flex', justifyContent: 'flex-end', paddingTop: '1rem', borderTop: '1px solid var(--border-glass)' }}>
